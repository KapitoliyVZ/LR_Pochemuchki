//  Данный заголовочный файл содержит объявления глоабльных переменных и прототипы основных программных единиц основного файла приложения:
//  - Основные константы и переменные, используемые в приложении.
//  - Прототипы функций, отвечающих за создание и обработку окон, кнопок и других элементов интерфейса.
...
// Структура для хранения начальных размеров окна
