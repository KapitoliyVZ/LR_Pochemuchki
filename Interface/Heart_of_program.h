//  Данный заголовочный файл содержит основную функцию - объединение для запуска ключевых этапов обработки текста, реализует:
//  - Объединение этапов : разбиение текста на предложения, поиск рифм по частям речи, добавление нумерации предложений и поиск упоминаний слов.
//  - Передачу и обработку данных между основными модулями анализа текста и рифм.
